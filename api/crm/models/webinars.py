...
class Webinars(ModelApi):
    ...
    img_present = models.ImageField(upload_to='webinars/presents/', blank=True, null=True)
    wallpaper_img = models.ImageField(upload_to='webinars/wallpapers/', blank=True, null=True)
