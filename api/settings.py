...
CRONJOBS = [
    # test monitoreo telemetria
    #('* * * * *', 'api.crm.cron_test.main',  '>> ' + os.path.join(BASE_DIR,'api/log/debug_test.log' + ' 2>&1 ')),
    # monitoreo smart hydro
    ('0 * * * *', 'api.crm.cron.main',  '>> ' + os.path.join(BASE_DIR,'api/log/debug7.log' + ' 2>&1 ')),
    # monitoreo smart hydro
    ('*/5 * * * *', 'api.crm.cron5.main',  '>> ' + os.path.join(BASE_DIR,'api/log/debug7_cron5.log' + ' 2>&1 ')),
    # estandar mayor
    ...
    # estandar menor
    ('27 13 1 * *', 'api.crm.cronjobs_dga.cron_dgamenor.main',  '>> ' + os.path.join(BASE_DIR,'api/log/debug_crondgamedio.log' + ' 2>&1 ')),
    # estandar caudales muy pequenos
    ('40 14 1 12 *', 'api.crm.cronjobs_dga.cron_dgamuypequenos.main',  '>> ' + os.path.join(BASE_DIR,'api/log/debug_crondgamedio.log' + ' 2>&1 ')),
]
