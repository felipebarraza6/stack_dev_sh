...
const TimeLineProcess = () => {
    ...
    return(<Timeline style={styles.timeline}>        
        ...
        {validated_info.client_info ? 
            <Item color='green' dot={<CheckCircleFilled />}>
                <Paragraph>Datos de contacto</Paragraph>
                    <Row>                    
                        ...
                        <Col span={24}>
                            <Tag color={'geekblue'} style={styles.tagClient}>ID:{client.client}</Tag>
                        </Col>
                    </Row>
            ...
            <Item color='red'>
                No has seleccionado al cliente e ingresado receptor de visita
                <br/>
                <br/>
                <Paragraph style={{paddingLeft:'10px'}}><CloseSquareFilled style={{color:'red'}} /> Nombre </Paragraph>            
                <Paragraph style={{paddingLeft:'10px'}}><CloseSquareFilled style={{color:'red'}} /> Email</Paragraph>
                <Paragraph style={{paddingLeft:'10px'}}><CloseSquareFilled style={{color:'red'}} /> Teléfono </Paragraph>
                <Paragraph style={{paddingLeft:'10px'}}><CloseSquareFilled style={{color:'red'}} /> Cliente </Paragraph>
            </Item>}  
    </Timeline>)
